...
#define write_finder_pattern(x, y, matrix)                                                                                                                                                             \
  {                                                                                                                                                                                                    \
    write_rings(x, y, 9, matrix, QR_MATRIX_WHITE_VALUE, 255);                                                                                                                                          \
    matrix[(y) + 4][(x) + 4] = QR_MATRIX_BLACK_VALUE;                                                                                                                                                  \
  }
#define write_alignment_pattern(x, y, matrix)                                                                                                                                                          \
  {                                                                                                                                                                                                    \
    write_rings(x, y, 5, matrix, QR_MATRIX_BLACK_VALUE, 255);                                                                                                                                          \
  }
...
static inline void write_alignment_patterns(uint8_t matrix[MAX_QR_MATRIX_SIZE][MAX_QR_MATRIX_SIZE]) {
...
void write_patterns(uint8_t matrix[MAX_QR_MATRIX_SIZE][MAX_QR_MATRIX_SIZE]) {
  ...
  write_alignment_patterns(matrix);
}
