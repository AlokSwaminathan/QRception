...
// Writes data in big endian, so MSB comes before LSB (This is how the bit stream should be in QR Codes)
// Will always write <bit> bits
// Returns number of bits written
// Writes to an array that stores one bit in each index
